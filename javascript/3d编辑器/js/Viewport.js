...
var Viewport = function ( editor ) {
	...
	//
	var transformControls = editor.transformControl = new THREE.TransformControls( camera, container.dom );
	...
	//此时,将contorl赋值给editorControl
	var controls = editor.editorControl = new THREE.EditorControls( camera, container.dom );
