...
Sidebar.Scene = function ( editor ) {
	...
	container.addStatic( new UI.Text( l['SCENE'] ) );
	...
	fogTypeRow.add( new UI.Text( l['Fog'] ).setWidth( '90px' ) );
	...
	fogColorRow.add( new UI.Text( l['Fog color'] ).setWidth( '90px' ) );
	...
	fogNearRow.add( new UI.Text( l['Fog near'] ).setWidth( '90px' ) );
	...
	fogFarRow.add( new UI.Text( l['Fog far'] ).setWidth( '90px' ) );
	...
	fogDensityRow.add( new UI.Text( l['Fog density'] ).setWidth( '90px' ) );
