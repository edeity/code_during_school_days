...
export default class ReactAce extends Component {
    ...
    onScroll() {
        if(this.props.onScroll) {
            ...
            let maxTop = renderer.layerConfig.maxHeight - renderer.$size.scrollerHeight + renderer.scrollMargin.bottom;
            let scrollTop = this.editor.getSession().getScrollTop();
            let scrollRatio = scrollTop / maxTop;
            this.props.onScroll(scrollRatio);
        }
    }
    render() {
